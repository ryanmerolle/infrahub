...
class StaticDeclaredPythonAttributes:
    """Serves a fixed list of declared ``(kind, attribute)`` pairs."""

    def __init__(self, declared: list[tuple[str, str]]) -> None:
...
class StaticAnalyzedPythonReadSets:
    ...
    def __init__(self, analyzed: dict[tuple[str, str], TransformReadSet]) -> None:
